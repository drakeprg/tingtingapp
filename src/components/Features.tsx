...
const Features = () => {
  ...
  // Set first feature (index 0) as default open
  ...
  const features = [
    {
      title: t.digitalCouponsTitle,
      subtitle: t.digitalCouponsSubtitle,
      description: t.digitalCouponsDesc,
      image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80',
      details: [
        t.digitalCouponsDetail1,
        t.digitalCouponsDetail2,
        t.digitalCouponsDetail3
      ]
    },
    {
      title: t.stampCardTitle,
      subtitle: t.stampCardSubtitle,
      description: t.stampCardDesc,
    ...
    },
    {
      ...
      details: [
        t.pushNotificationsDetail1,
        t.pushNotificationsDetail2,
        t.pushNotificationsDetail3
      ]
    },
    {
      title: t.reservationSystemTitle,
      subtitle: t.reservationSystemSubtitle,
      description: t.reservationSystemDesc,
      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=800&q=80',
      details: [
        t.reservationSystemDetail1,
        t.reservationSystemDetail2,
        t.reservationSystemDetail3
      ]
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            {/* Left Sidebar - Collapsible Feature List */}
            <div className="lg:col-span-2 space-y-2" style={{ minHeight: '500px' }}>
              {features.map((feature, index) => (
                <div key={index} className="border-b border-gray-200 dark:border-gray-800 last:border-b-0">
                  ...
                  <button
                    ...
                    className="w-full py-6 px-4 text-left flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors rounded-lg"
                  >
                    <div className="flex-1">
                      <h3 className={`text-xl font-semibold transition-colors ${
                        activeFeature === index
                          ? 'text-christalle dark:text-viking'
                    ...
                    <div className="ml-4">
                      {activeFeature === index ? (
                        <ChevronUp className="w-5 h-5 text-christalle dark:text-viking" />
                      ) : (
                  ...
                  {activeFeature === index && (
                    <div className="px-4 pb-6 animate-fade-in">
                      <p className="text-gray-900 dark:text-viking font-medium mb-3">
                        {feature.subtitle}
                      </p>
                      ...
                      <div className="space-y-2">
                        {feature.details.map((detail, detailIndex) => (
                          <div key={detailIndex} className="flex items-start space-x-3">
                            <div className="w-1.5 h-1.5 bg-christalle dark:bg-viking rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="lg:col-span-3">
              <div className="sticky top-8">
                <div className="relative overflow-hidden rounded-3xl bg-gray-100 dark:bg-gray-800" style={{ height: '500px' }}>
                  {activeFeature !== null ? (
                    <>
                      <img
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
                      <div className="text-center">
                        <div className="w-16 h-16 mx-auto mb-4 bg-christalle rounded-2xl flex items-center justify-center">
                ...
                <div className="lg:hidden mt-6 flex space-x-2 overflow-x-auto pb-2">
                  {features.map((feature, index) => (
                    <button
                      key={index}
                      onClick={() => toggleFeature(index)}
