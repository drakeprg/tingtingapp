            ...
            <div className="grid lg:grid-cols-2 items-center min-h-[500px]">
              ...
              <div className="relative h-full min-h-[500px] flex items-center justify-center p-8">
                ...
                <div className="relative">
                  <div className="w-72 h-[580px] bg-white rounded-[3rem] shadow-2xl overflow-hidden transform rotate-12 hover:rotate-6 transition-transform duration-500">
                    {/* Status Bar */}
                    ...
                    <div className="h-full bg-gradient-to-b from-blue-50 to-white p-6">
                      <div className="text-center space-y-6">
                        {/* Logo */}
                        <div className="w-16 h-16 mx-auto bg-christalle rounded-2xl flex items-center justify-center">
                        ...
                        {/* Company Name */}
                        <div>
                          <div className="text-xl font-black text-gray-900" style={{ fontFamily: 'Be Vietnam Pro, sans-serif' }}>
                            {t.yourBusiness}
                          </div>
                          <div className="text-sm text-gray-500">{t.professionalPresentation}</div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border">
                          <div className="space-y-3">
                            ...
                            <div className="h-16 bg-gradient-to-r from-christalle/20 to-viking/20 rounded"></div>
                        ...
                        <div className="space-y-2 text-left">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs text-gray-600">{t.responsiveDesign}</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span className="text-xs text-gray-600">{t.seoOptimization}</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span className="text-xs text-gray-600">{t.fastLoading}</span>
                          </div>
                        </div>
                      </div>
                    </div>
