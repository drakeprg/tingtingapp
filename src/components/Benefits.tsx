...
import { Ticket, Star, Coins, Bell, Calendar, Wallet, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Benefits = () => {
  ...
  const features = [
    { 
      icon: Ticket, 
      title: t.smartCoupons, 
      description: t.smartCouponsDesc
    },
    { 
      icon: Star, 
      title: t.digitalStamps, 
      description: t.digitalStampsDesc
    },
    { 
      icon: Coins, 
      title: t.pointSystem, 
    ...
    { 
      icon: Calendar, 
      title: t.onlineReservations, 
      description: t.onlineReservationsDesc
    },
    { 
      icon: Wallet, 
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-12">
            ...
            <a 
              href="#" 
              className="text-christalle dark:text-viking hover:underline text-lg font-medium hidden md:block mt-4"
            >
              {t.allFeatures}
            </a>
          </div>
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex space-x-2">
              <Button
                ...
                size="icon"
                onClick={scrollLeft}
                className="w-10 h-10 rounded-full border-gray-300 dark:border-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200"
              >
          ...
          {/* Horizontal Scrolling Features - Apple Style */}
            ...
            >
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex-shrink-0 w-80 bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-600 group"
                  >
                    {/* Simple Icon - Matching Text Color */}
                    <div className="mb-6">
                      <IconComponent className="w-12 h-12 text-gray-900 dark:text-white group-hover:scale-105 transition-transform duration-300" />
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-200 leading-relaxed text-base">
                        {feature.description}
                      </p>
                    </div>
                    ...
                    <div className="mt-6">
                      <a 
                        href="#" 
                        className="text-christalle dark:text-viking hover:underline font-medium inline-flex items-center"
                      >
                        {t.learnMore}
