...
import { ArrowLeft, Eye, EyeOff, Check, Building, User, Mail, Lock, Phone } from 'lucide-react';
...
const Registration: React.FC<RegistrationProps> = ({ onNavigate }) => {
  ...
  const benefits = [
    language === 'cs' ? 'Neomezené věrnostní karty' : 'Thẻ khách hàng thân thiết không giới hạn',
    language === 'cs' ? 'Push notifikace zdarma' : 'Thông báo đẩy miễn phí',
    language === 'cs' ? 'Apple & Google Wallet integrace' : 'Tích hợp Apple & Google Wallet',
    language === 'cs' ? 'Pokročilé analýzy' : 'Phân tích nâng cao',
    language === 'cs' ? 'Podpora v češtině 24/7' : 'Hỗ trợ 24/7'
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={language === 'cs' ? 'Název vašeho podniku' : 'Tên doanh nghiệp của bạn'}
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-christalle focus:border-transparent"
                        placeholder={language === 'cs' ? 'Jméno' : 'Tên'}
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-christalle focus:border-transparent"
                      placeholder={language === 'cs' ? 'Příjmení' : 'Họ'}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-christalle focus:border-transparent"
                      placeholder={language === 'cs' ? '+420 123 456 789' : '+84 123 456 789'}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={language === 'cs' ? 'Minimálně 8 znaků' : 'Tối thiểu 8 ký tự'}
                    />
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-christalle focus:border-transparent"
                      placeholder={language === 'cs' ? 'Zopakujte heslo' : 'Nhập lại mật khẩu'}
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-4">
                  <label className="flex items-start space-x-3 cursor-pointer">
                    <input
                      ...
                      className="mt-1 w-4 h-4 text-christalle border-gray-300 rounded focus:ring-christalle"
                      required
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      {t.agreeTerms}{' '}
                      <a href="#" className="text-christalle dark:text-viking hover:underline">
                        {t.termsConditions}
                      </a>{' '}
                      {t.and}{' '}
                      <a href="#" className="text-christalle dark:text-viking hover:underline">
              ...
              <div className="text-center mt-6">
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <button
                    ...
                    className="text-christalle dark:text-viking hover:underline font-medium"
                  >
                    {t.signInLink}
                  </button>
                </p>
      ...
      {/* Right Side - Benefits */}
      <div className="hidden lg:flex flex-1 bg-christalle items-center justify-center p-12">
        <div className="max-w-md text-white">
          <h2 className="text-4xl font-semibold mb-6">
            {language === 'cs' ? 'Začněte budovat věrnost ještě dnes' : 'Bắt đầu xây dựng lòng trung thành ngay hôm nay'}
          </h2>
          <p className="text-white/90 mb-8 text-lg">
            {language === 'cs' 
              ? 'Připojte se k více než 500 podnikům, které už používají tingting pro zvýšení návštěvnosti a tržeb.'
              : 'Tham gia cùng hơn 500 doanh nghiệp đã sử dụng tingting để tăng lượng khách và doanh thu.'
            }
          </p>
          ...
          <div className="mt-12 p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
            ...
            <div className="text-3xl font-bold mb-2">{t.days30Free}</div>
